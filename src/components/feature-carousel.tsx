...
export interface ServiceCarouselProps extends CardProps {
...
const steps: readonly Step[] = [
  {
    ...
    description: "We dive deep into user behavior and market research to build a foundation for success.",
  },
  {
    id: "2",
    name: "Design",
    title: "Conceptual Design",
    description: "Our design process transforms complex problems into elegant, high-fidelity interfaces.",
  },
  {
    id: "3",
    name: "Engineering",
    title: "Modern Engineering",
    description: "We build with Next.js and Tailwind to ensure your application is fast, accessible, and scalable.",
  },
  {
    id: "4",
    name: "Deployment",
    title: "Global Deployment",
    description: "Ship with confidence using our automated CI/CD pipelines and cloud-native infrastructure.",
  },
] as const
...
function FeatureCard({
  ...
  return (
    ...
    >
      ...
      >
        <div className="m-6 md:m-10 min-h-[500px] w-full flex flex-col md:flex-row gap-8 items-center">
          <AnimatePresence mode="wait">
            <motion.div
              key={step}
              className="w-full md:w-5/12 flex flex-col gap-4 z-20 relative"
            ...
            >
              ...
              >
                <p className="text-base leading-relaxed text-neutral-300 dark:text-zinc-400">
          ...
          <div className="w-full md:w-7/12 h-[300px] md:h-[400px] relative overflow-hidden rounded-2xl bg-white/5 border border-white/10 shadow-inner">
...
const defaultClasses = {
  step1img1:
    "pointer-events-none absolute w-[60%] left-0 top-[60%] -translate-y-1/2 border border-white/10 transition-all duration-500 rounded-2xl shadow-2xl z-10",
  step1img2:
    "pointer-events-none absolute w-[70%] right-0 top-[40%] -translate-y-1/2 border border-white/10 transition-all duration-500 overflow-hidden rounded-2xl shadow-2xl z-20",
  step2img1:
    "pointer-events-none absolute w-[60%] left-0 top-[40%] -translate-y-1/2 border border-white/10 transition-all duration-500 rounded-2xl overflow-hidden shadow-2xl z-10",
  step2img2:
    "pointer-events-none absolute w-[60%] right-0 top-[60%] -translate-y-1/2 border border-white/10 transition-all duration-500 rounded-2xl overflow-hidden shadow-2xl z-20",
  step3img:
    "pointer-events-none absolute w-[90%] left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 border border-white/10 rounded-2xl transition-all duration-500 overflow-hidden shadow-2xl",
  step4img:
    "pointer-events-none absolute w-[90%] left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 border border-white/10 rounded-2xl transition-all duration-500 overflow-hidden shadow-2xl",
} as const
