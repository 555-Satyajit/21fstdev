                ...
                <ScrollArea className="h-16 grow p-2">
                  <div className={cn("flex w-full flex-col gap-1")}>
                    <Link
                      href="/dashboard"
                      className={cn(
                        "flex h-9 w-full flex-row items-center rounded-md px-2 py-1.5 transition-all hover:bg-white/5",
                        pathname === "/dashboard" &&
                    ...
                    >
                      ...
                      <motion.li variants={variants}>
                        {!isCollapsed && (
                          <p className="ml-2 text-sm font-semibold">Overview</p>
                        )}
                      </motion.li>
                    </Link>
                    <Link
                      ...
                      <motion.li variants={variants}>
                        {!isCollapsed && (
                          <div className="flex items-center gap-2">
                            <p className="ml-2 text-sm font-semibold">Edge Nodes</p>
                          </div>
                        )}
                      </motion.li>
                    </Link>
                    ...
                    <Link
                      ...
                      className={cn(
                        "flex h-9 flex-row items-center rounded-md px-2 py-1.5 transition-all hover:bg-white/5",
                        pathname?.includes("traffic") && "bg-white/10 text-lime-400",
                      )}
                    >
                      ...
                      <motion.li variants={variants}>
                        {!isCollapsed && (
                          <div className="ml-2 flex items-center  gap-2">
                            <p className="text-sm font-semibold">Live Traffic</p>
                            <Badge
                              className={cn(
                                "flex h-fit w-fit items-center gap-1.5 rounded border-none bg-lime-400/10 px-1.5 text-lime-400",
                              )}
                              variant="outline"
                            >
                              LIVE
                    ...
                    <Link
                      ...
                      className={cn(
                        "flex h-9 w-full flex-row items-center rounded-md px-2 py-1.5 transition-all hover:bg-white/5",
                        pathname?.includes("analytics") && "bg-white/10 text-lime-400",
                      )}
                    >
                      <Layout className="h-4 w-4" />{" "}
                      <motion.li variants={variants}>
                        {!isCollapsed && (
                          <p className="ml-2 text-sm font-semibold">Neural Analytics</p>
                        )}
                      </motion.li>
                    </Link>
                    <Link
